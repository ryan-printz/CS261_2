...
void GameState_Server::load(void)
{
...
void GameState_Server::init(void)
{
...
void GameState_Server::update(void)
{
	// =================
	// update the input
	// =================
...
void GameState_Server::draw(void)
{
	s8 strBuffer[1024];
...
void GameState_Server::free(void)
{
...
void GameState_Server::unload(void)
{
	// free all mesh
...
void GameState_Server::loadGameObjList()
{
	GameObj* pObj;
...
GameObjInst* GameState_Server::gameObjInstCreate(u32 type, f32 scale, AEVec2* pPos, AEVec2* pVel, f32 dir, bool forceCreate)
{
...
void GameState_Server::gameObjInstDestroy(GameObjInst* pInst)
{
...
GameObjInst* GameState_Server::astCreate(GameObjInst* pSrc)
{
	GameObjInst* pInst;
	AEVec2		 pos, vel;
	f32			 t, angle, size;
...
void GameState_Server::resolveCollision(GameObjInst* pSrc, GameObjInst* pDst, AEVec2* pNrm)
{
...
void GameState_Server::sparkCreate(u32 type, AEVec2* pPos, u32 count, f32 angleMin, f32 angleMax, f32 srcSize, f32 velScale, AEVec2* pVelInit)
{
...
GameObjInst* GameState_Server::missileAcquireTarget(GameObjInst* pMissile)
{
	AEVec2		 dir, u;
